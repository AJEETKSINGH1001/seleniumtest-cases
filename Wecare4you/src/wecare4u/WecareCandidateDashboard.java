...
public class WecareCandidateDashboard {
    
    public static void main(String[] args) {
        // TODO Auto-generated method stub
    	
        String homePage = "https://wecare4u.co/uat/";
        String url = "";
		...
		String baseUrl = "https://wecare4u.co/uat/my-account";
		driver.get(baseUrl);
		driver.getTitle();
	...
	//matching the titles 
	    if (actualTitle.contentEquals(expectedTitle)){
	      ...
	      //Go to Page    
     driver.get("https://wecare4u.co/uat/login/Login");
     
     System.out.println("welcome to login page");
     // Type username  
     WebElement username = driver.findElement(By.name("email"));  
     username.clear();  
     username.sendKeys("deltastar2.gopal@gmail.com");  
    ...
    int summation = Integer.parseInt(part1) + Integer.parseInt(part11);  
     ...
     Assert.assertTrue(driver.getCurrentUrl().matches("https://wecare4u.co/uat/my-account"), "Invalid credentials");
     System.out.println("Login to wecare4you andidate admin Successfully!!");
     //dashboard button
       // driver.manage().window().maximize();
        
        driver.get("https://wecare4u.co/uat/my-account");
